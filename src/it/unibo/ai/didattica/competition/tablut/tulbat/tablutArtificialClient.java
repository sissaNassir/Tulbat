...
import it.unibo.ai.didattica.competition.tablut.tulbat.MonteCarlo.MyIterative;
...
public class tablutArtificialClient extends TablutClient {
    ...
    public void run() {
        ...
        // set type of game
        MyGameAshtonTablut tablutGame = new MyGameAshtonTablut(0, -1, "logs", "white_ai", "black_ai");;
...
// inserire chaiamta all'algoritmo di ricerca
...
*/
    private Action findBestMove(MyGameAshtonTablut tablutGame, State state) {

        MyIterative search = new MyIterative(tablutGame,Double.MIN_VALUE, Double.MAX_VALUE,this.timeout - 1);
